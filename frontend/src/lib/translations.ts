...
const corridorMap: Record<string, string> = {
  "沿江口门群": "Yangtze gateway group",
  "京杭运河": "Grand Canal group",
  "京杭主通道": "Grand Canal group",
  "苏南": "Southern Jiangsu group",
  "苏南入江支网": "Southern Jiangsu group",
  "苏中": "Central Jiangsu group",
  "通扬-里下河网络": "Central Jiangsu group",
  "通扬—里下河网络": "Central Jiangsu group",
  "苏北": "Northern Jiangsu group",
  "淮河-徐宿西北网络": "Northern Jiangsu group",
  "淮河—徐宿西北网络": "Northern Jiangsu group",
  "盐河-连申-出海网络": "Northern Jiangsu group",
  "盐河—连申—出海网络": "Northern Jiangsu group",
  "其他": "Other group",
};
